...
class Task(Generic[A]):
    ...
    This class encapsulates a runner function and its arguments, allowing the task
    to be executed asynchronously. Each task is associated with a unique ID and an owner.
    ...
    Args:
        ...
        runner (Callable[[A], Awaitable[None]]): An async function that takes arguments of type 'A'.
    ...
    def __eq__(self, other: "Task[A]") -> bool:
